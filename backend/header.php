      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="category_create.php"><i class="fas fa-plus"></i> Create Category</a>
            <a class="collapse-item" href="category_list.php"><i class="fas fa-list"></i> List Category</a>
          </div>
        </div>
      </li>
     <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapseNews" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="news_create.php"><i class="fas fa-plus"></i> Create News</a>
            <a class="collapse-item" href="news_list.php"><i class="fas fa-list"></i> List News</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseAdvertisement" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            
            <a class="collapse-item" href="advertisement_create.php"><i class="fas fa-plus"></i> Create Advertisement</a>
            <a class="collapse-item" href="advertisement_list.php"><i class="fas fa-list"></i> List Advertisement</a>
          </div>
        </div>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="comment_list.php">

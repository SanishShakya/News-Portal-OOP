      ...
      <form action="" method="post" id="loginForm" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="category_id">Category Name</label>
           <select name='category_id' class="form-control" id="category_id" required="required"  value="<?php echo $new[0]->name?>"></br>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="title"  placeholder="Enter News Title" name="title" required="required"  value="<?php echo $new[0]->title?>">
        </div>

  			<div class="form-group">
    			<label for="short_description">Short Description</label>
    			<textarea class="form-control" id="short_description" name="short_description" required="required"><?php echo $new[0]->short_description?></textarea> 
  			</div>

        <div class="form-group">
          <label for="description">Description</label>
          <textarea class="form-control" id="description" name="description" required="required"><?php echo $new[0]->description?></textarea> 
        </div>
        ...
        <div class="form-group">
          ...
          <input type="radio" id="deactive" name="breaking_key" value="0" required="required">De-Active
  			...
  			<button type="submit" name="btnUpdate" class="btn btn-primary"><i class="fas fa-redo"></i> Update News</button>
  		</form>
